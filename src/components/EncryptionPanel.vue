...
const passwordFieldLabel = computed(() => 
  isPanelForEncryption.value ? 'Heslo pro šifrování' : 'Heslo pro dešifrování'
);

const showWarning = computed(() => 
  isPanelForEncryption.value && encryptionType.value !== 'none'
);
...
watch(() => props.autoDetectedType, (newType) => {
